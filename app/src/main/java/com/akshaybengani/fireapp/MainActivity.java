...
// We have to use "implementation 'com.google.firebase:firebase-auth:11.0.4'" in the app/gradle file
        ...
        firebaseAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    Toast.makeText(MainActivity.this,"Congratulations You have registered Successfully",Toast.LENGTH_SHORT).show();
                ...
                else
                {
                    ...
                    Toast.makeText(MainActivity.this,"Sorry... Registration Unsuccessfull please try again...",Toast.LENGTH_SHORT).show();
